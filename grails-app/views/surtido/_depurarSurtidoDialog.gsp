<div class="modal fade" id="depuracionDeSurtidoModal" tabindex="-1" role="dialog" 
  aria-labelledby="depuracionDeSurtidoModal" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="depuracionDeSurtidoModal">TITULO</h4>
      </div>
      <g:form  action="depurar" >
...
<script type="text/javascript">
    $(document).ready(function(){
      $('#depuracionDeSurtidoModal').on('show.bs.modal', function (event) {
        var button = $(event.relatedTarget); 
        var recipient = button.data('whatever'); 
        var modal = $(this);
        modal.find('.modal-title').text('Depuración de surtido: ' + recipient);
